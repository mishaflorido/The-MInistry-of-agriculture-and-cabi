    ...
    columnDefs: [
      {
        ...
        render: function (data, type, row) {
          return (
            ...
            " " +
            row.mo_last_name +
            "</span><input class='id_farm' type='hidden' name='id_farm_other' value=" +
            row.id_farm +
            ">"
          );
        },
      },
      {
        ...
        render: function (data, type, row) {
          return (
            "<span><i class='fas fa-hashtag'></i>&nbsp;" + data + "</span>"
          );
        },
      },
      {
...
function to_pdf_farmer(farmer) {
  ...
  doc.text(25, 40, "Grenada and Ministry of agricultural, lands and forestry");
  doc.setFontType("bold");
  doc.setFontSize(12);
  ...
  doc.text(
    18,
    165,
    "6. NAME(S) OF OTHERS IN HOUSEHOLD/GROUP INVOLVED IN THE FARMING BUSINESS"
  );
